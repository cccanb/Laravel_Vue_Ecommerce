    ...
    <x-slot name="header">
        ...
        <div class="mt-3 text-sm">
            <a href="{{ route('dashboard') }}" class="text-blue-500 underline"><i class="bi bi-house"></i></a> -> <a
                href="{{ route('user.index') }}" class="text-blue-500 underline">Users</a> -> <span>Add new
                user</span>
        </div>
    </x-slot>
    ...
    <form action="{{ route('user.store') }}" method="post"
        ...
        <div class="mb-4">
            ...
            <input id="password_confirmation" type="password" name="password_confirmation" autocomplete="new-password"
                required class="w-full px-4 py-2 border rounded-md focus:outline-none focus:border-blue-500">
