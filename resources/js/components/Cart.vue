        ...
        <div class="col-span-2">
            <table class="w-full text-gray-700 shadow-md">
                <thead>
                    <tr class="border-b">
                        <th
                            class="py-4 px-6 text-left font-medium uppercase"
                        ></th>
                        <th class="py-4 px-6 text-left font-medium uppercase">
                            Product
                        </th>
                        <th class="py-4 px-6 text-left font-medium uppercase">
                            Quantity
                        </th>
                        <th class="py-4 px-6 text-right font-medium uppercase">
                            Price
                        </th>
                    </tr>
                </thead>
                <tbody>
                    <tr class="border-b">
                        <td>
                            <img
                                class="max-w-xs"
                                :src="'images/jersey-front-black-small.png'"
                                alt="Thumbnail"
                            />
                        </td>
        ...
        <div class="bg-white shadow-md">
            ...
            <div class="mt-6 mx-6">
                ...
                <div class="flex items-center">
                    ...
                    />
                    <button
                        class="bg-gray-300 text-white py-2 px-4 hover:bg-gray-400"
                    >
                        Apply
                    </button>
                </div>
            ...
            <div class="mx-6 my-6 flex justify-end">
                <button
                    class="bg-green-700 text-white py-2 px-4 hover:bg-green-500"
                >
                    Checkout now
                </button>
            </div>
